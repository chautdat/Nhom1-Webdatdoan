...
export default {
  ...
  methods: {
    ...
    async saveProduct() {
      ...
      try {
        ...
        if (this.selectedFile) {
          ...
          imageUrl = this.normalizeImageStorageUrl(uploadRes);
        }
    ...
    normalizeImageStorageUrl(value) {
      if (!value) return "";

      if (typeof value === "object") {
        return this.normalizeImageStorageUrl(
          value.path || value.url || value.filename || value.imageUrl || ""
        );
      }
    ...
    getImageUrl(url) {
      ...
      if (!raw) return "/images/notfound.png";
      ...
      return `${backendUrl}/uploads/${cleaned}`;
    },
